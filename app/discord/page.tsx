    ...
    <section className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
      <div className="w-full max-w-2xl">
        ...
        <div className="rounded-3xl overflow-hidden shadow-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 transition-all duration-300">
          ...
          {/* Discord Profile Header - Embedded style */}
          <div className="relative bg-[#5865F2] px-6 pt-8 pb-16">
            <div className="flex justify-center">
              <div className="w-24 h-24 bg-white rounded-2xl flex items-center justify-center shadow-lg transform -mb-12">
          ...
          <div className="px-6 pt-12 pb-6 text-center">
            ...
            <p className="text-sm text-[#5865F2] font-medium mb-4">
              ⚒️ Where Founders Rise
            </p>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-medium mb-5">
